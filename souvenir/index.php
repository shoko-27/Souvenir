					...
					<div class="banner-content">
						<div class="page-head-content">
							<div class="page-head-title text-capitalize pb40">
								<h1>Omiya.jp</h1>
								<span class="descrip">Japanese souvenir introduce site</span>
							</div>
							<!-- //title -->
				...
				<div class="row">
					<div class="portfolio-content">
											...
											<div class="work-item">
												...
												<div class="hover-content">
													...
													<div class="project-description text-uppercase ul-li">
														<h3><a href="#"><?php $row['brand_name']; ?></a></h3>
						...
						<div class="poppin-more text-uppercase text-center">
							<div class="more-btn">
								<a href="souvenir.html">MORE SEARCH</a>
							</div>
						</div>
						<!-- //.more -->
